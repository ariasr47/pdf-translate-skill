#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""CLI entry for bilingual. Implementation lives in pdf_translate.bilingual."""
import importlib
...
if __name__ == '__main__':
    ...
    _pre.guard_cli()
    raise SystemExit(importlib.import_module('pdf_translate.bilingual').main())

sys.modules[__name__] = importlib.import_module('pdf_translate.bilingual')